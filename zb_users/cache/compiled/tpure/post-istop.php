...
<div class="post item">
    <h2><span title="[<?php  echo $lang['msg']['top'];  ?>]" class="istop"></span><a href="<?php  echo $article->Url;  ?>"<?php if ($zbp->Config('tpure')->PostBLANKSTYLE == 2) { ?> target="_blank"<?php } ?>><?php  echo $article->Title;  ?></a></h2>
    <div class="info<?php if ($zbp->Config('tpure')->PostISTOPSIMPLEON == '1') { ?> simple<?php } ?>">
        <?php 
        $post_info = array(
    ...
    <?php if ($zbp->Config('tpure')->PostISTOPSIMPLEON == '0') { ?>
