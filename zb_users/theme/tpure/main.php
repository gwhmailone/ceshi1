...
if ($act == 'base') {
    if (isset($_POST['PostLOGO'])) {
        ...
        $zbp->Config('tpure')->PostBANNERURL = $_POST['PostBANNERURL'];         //首页banner文字内容
        ...
        $zbp->Config('tpure')->PostAJAXPOSTON = $_POST['PostAJAXPOSTON'];		//主题设置页无刷新提交开关
...
<dl>
	<form method="post" class="setting">
		...
		<dd>
			...
			<table>
				<tbody>
					...
					<tr>
						<td><?php if ($zbp->Config('tpure')->PostLOGO) { ?><img src="<?php echo $zbp->Config('tpure')->PostLOGO; ?>" width="120" class="thumbimg" /><?php } else { ?><img src="style/images/logo.svg" width="120" class="thumbimg" /><?php } ?></td>
        ...
        echo $zbp->host . 'zb_users/theme/tpure/style/images/thumb.png';
						...
						<td><input type="button" class="uploadimg format" value="上传"></td>
						<td><br>无图用默认 <input type="text" id="PostTHUMBON" name="PostTHUMBON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostTHUMBON; ?>" /><br>无图用随机 <input type="text" id="PostRANDTHUMBON" name="PostRANDTHUMBON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostRANDTHUMBON; ?>" /><br>仅显示有图 <input type="text" id="PostIMGON" name="PostIMGON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostIMGON; ?>" /><br>侧栏缩略图 <input type="text" id="PostSIDEIMGON" name="PostSIDEIMGON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostSIDEIMGON; ?>" /><br><br></td>
					</tr>
				</tbody>
			</table>
			<i class="help"></i><span class="helpcon">使用默认缩略图，请开启“无图用默认”和“仅显示有图”开关；<br>使用随机缩略图，请开启“无图用随机”和“仅显示有图”开关；<br>仅显示文章缩略图，只需开启“仅显示有图”开关；<br>如不需要任何缩略图，请全部关闭；<br>侧栏模块缩略图继承以上设置。</span>
		</dd>
		<dd>
			...
			<table>
				<tbody>
					...
					<tr>
						<th colspan="2">Banner超链接</th>
						<th>电脑端高度</th>
						<th>移动端高度</th>
					</tr>
					<tr>
						<td colspan="2"><input type="text" id="PostBANNERURL" name="PostBANNERURL" value="<?php echo $zbp->Config('tpure')->PostBANNERURL; ?>" class="urltext thumbsrc" style="width:390px;"></td>
			...
			<i class="help"></i><span class="helpcon">展示首页Banner，请将启用开关设置为"ON"；<br>展示视差滚动效果，请将视差开关设置为"ON"；<br>全站每页都显示，请将全站展示开关设置为"ON"；<br>支持PC与移动端独立设置高度；<br>Banner不需要文字请留空；</span>
		</dd>
		<dt>搜索设置</dt>
		<dd data-stretch="search" class="half">
			<label>导航搜索</label>
        ...
        <div class="searchinfo"<?php echo $zbp->Config('tpure')->PostSEARCHON == 1 ? '' : ' style="display:none"'; ?>>
		<dd class="half">
    ...
    if (count((array)$list_info) == 7) {
        ...
        echo '<div class="checkui ui-sortable-handle">删除(仅管理可见)<input name="post_list_info[del]" value="0"></div>';
            ...
            <i class="help"></i><span class="helpcon">列表页面辅助信息，自定义选择启用，支持拖拽排序。</span>
		</dd>
    ...
    if (count((array)$page_info) == 6) {
		...
		<dd class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为仅显示文章页所在分类下的相关文章；<br>“OFF”为显示标签相关的所有分类文章。</span>
		</dd>
		<dd class="half">
        ...
        <dd class="half">
            ...
            <i class="help"></i><span class="helpcon">“ON”为显示评论表单中邮箱文本框；<br>“OFF”为隐藏评论表单中邮箱文本框；<br>若关闭邮箱，则评论无法使用QQ或gravatar头像。<br><em>注：输入邮箱会自动显示符合类型的头像；</em></span>
        </dd>
        <dd class="half">
            <label>评论网址</label>
            <input type="text" id="PostCMTSITEON" name="PostCMTSITEON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostCMTSITEON; ?>" />
            <i class="help"></i><span class="helpcon">“ON”为显示评论表单中网址文本框；<br>“OFF”为隐藏评论表单中网址文本框；<br><em>注：网址在评论头像 / 姓名和读者墙中可点击。</em></span>
        </dd>
        <dd>
        ...
        <dd data-stretch="copynotice" class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为显示文章页版权声明；<br>“OFF”为隐藏文章页版权声明；<br><em>注：版权声明仅文章页显示。</em></span>
		</dd>
        ...
        <dd class="half">
            ...
            <i class="help"></i><span class="helpcon">“ON”为移动端隐藏文章版权声明；<br>“OFF”为PC和手机端均显示文章页版权声明；</span>
        </dd>
		<dd class="half">
			<label>本页链接地址</label>
			<input type="text" id="PostCOPYURLON" name="PostCOPYURLON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostCOPYURLON; ?>" />
			<i class="help"></i><span class="helpcon">“ON”为显示版权声明当前页面链接地址；<br>“OFF”为隐藏版权声明当前页面链接地址；</span>
		</dd>
		<dd class="half">
			<label>二维码功能</label>
		...
		<dd class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为显示归档文章前的日期；<br>“OFF”为隐藏归档文章前的日期。</span>
		</dd>
		<dd class="half">
        ...
        <dd data-stretch="friendlink" class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为显示首页底部友情链接模块；<br>“OFF”为隐藏首页底部友情链接模块。</span>
		</dd>
		...
		<dd class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为移动端显示友情链接；<br>“OFF”为移动端隐藏友情链接。</span>
		</dd>
        </div>
		...
		<dd class="half">
			...
			<i class="help"></i><span class="helpcon">“ON”为隐藏置顶缩略图、摘要及查看全文按钮；<br>“OFF”为常规列表显示。</span>
		</dd>
        <dd class="half">
            <label>PC大图列表</label>
            ...
            <i class="help"></i><span class="helpcon">“ON”为放大列表缩略图，摘要最多显示4行；<br>“OFF”为默认缩略图大小，摘要最多显示3行；<br><em>仅PC端放大缩略图，侧栏和相关文章缩略图大小不受影响；</em></span>
        </dd>
		<dd class="half">
			<label>导航悬浮</label>
        ...
        <dd class="half">
            ...
            <i class="help"></i><span class="helpcon">“ON”为文章页显示tags标签；<br>“OFF”为文章页隐藏tags标签。</span>
        </dd>
        <dd class="half">
            <label>文章上下篇</label>
            <input type="text" id="PostPREVNEXTON" name="PostPREVNEXTON" class="checkbox" value="<?php echo $zbp->Config('tpure')->PostPREVNEXTON; ?>" />
            <i class="help"></i><span class="helpcon">“ON”为显示文章页上下篇文章及返回列表按钮；<br>“OFF”为隐藏文章页上下篇文章及返回列表按钮。</span>
        </dd>
        <dd class="half">
            <label>同分类上下篇</label>
        ...
        <dd class="half">
            ...
            <i class="help"></i><span class="helpcon">“ON”为启用文章正文字号放大缩小控件；<br>“OFF”为关闭文章正文字号放大缩小控件。<br>若字号无法控制，请检查该文章段落，清除格式再试。</span>
        </dd>
		<dd class="half">
			<label>清理空段落</label>
...
if ($act == 'seo') {
    if (isset($_POST['SEOON'])) {
		...
		$zbp->Config('tpure')->PostFOOTERADCODE = $_POST['PostFOOTERADCODE'];           //页尾自定义代码$footerad
...
?>
	...
	<dd>
        <label for="PostFOOTERADCODE">页尾广告代码</label><textarea name="PostFOOTERADCODE" id="PostFOOTERADCODE" cols="30" rows="3" class="setinput"><?php echo $zbp->Config('tpure')->PostFOOTERADCODE; ?></textarea><i class="help"></i><span class="helpcon">设置网站页尾广告代码。</span>
    </dd>
    <dd>
...
<dl>
	...
	<dd class="half">
        ...
        <i class="help"></i><span class="helpcon">设置侧栏悬浮的展现形式，默认为整体粘性悬浮。<br>侧栏整体高度大于内容区高度时不悬浮。</span>
    </dd>
    </div>
    <dt>侧栏“热评文章”模块设置</dt>
	<dd>
                                    ...
                                    <td width="58%">
                                        <div class="slideleft">
                                            <span class="slideimg dftimg">
                                                <span><input type="hidden" name="img" value="" class="thumbsrc" /><input type="button" value="" class="uploadimg uploadico" /></span>
                                ...
                                <td width="58%">
                                    <div class="slideleft">
                                        <span class="slideimg" style="background-color:#<?php echo $value['color']; ?>">
                                            <span><input type="hidden" name="img" value="<?php echo $value['img']; ?>" class="thumbsrc" /><input type="button" value="" class="uploadimg uploadico" /></span>
...
<?php } ?>
		...
		<form name="slide" method="post" class="setting">
			<dt>幻灯参数设置</dt>
			<dd data-stretch="slide" class="half">
				<label>启用幻灯</label>
			...
			<dd class="half">
				...
				<i class="help"></i><span class="helpcon">“ON”为启用视差效果，“OFF”为关闭视差效果；<br>效果仅局限于幻灯位置为替换首页Banner时生效；</span>
			</dd>
			<dd class="half">
			...
			<dd class="half">
				...
				<i class="help"></i><span class="helpcon">“ON”为显示幻灯底部分页条，“OFF”为隐藏幻灯底部分页条</span>
			</dd>
			<dd class="half">
			...
			<dd class="half">
				...
				<i class="help"></i><span class="helpcon">“ON”为显示幻灯左右箭头，“OFF”为隐藏幻灯左右箭头</span>
			</dd>
			<dd class="half">
				<label>淡入淡出切换</label>
...
<dl>
    ...
    <dd class="half">
        ...
        <input type="text" id="SMTP_PASS" name="SMTP_PASS" value="<?php echo $zbp->Config('tpure')->SMTP_PASS; ?>" class="settext" />
...
<dl>
    ...
    <dt>主题配置管理 <a target="_blank" href="plugin/export.php">导出主题设置</a></dt>
    <dd>
    ...
    <form method="post" class="setting">
        <input type="hidden" name="csrfToken" value="<?php echo $zbp->GetCSRFToken() ?>">
        <dt>主题设置信息 <a href="plugin/resetconfig.php" data-confirm="重置默认设置前，建议导出当前主题设置备份！">重置默认设置</a></dt>
        <dd>
            <label>保留设置信息</label>
